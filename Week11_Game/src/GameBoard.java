...
public class GameBoard extends JPanel {
	...
	private static final double initialBalls = 3;
	...
	Ship ship;
	int score = 0;
	Font fontScore = new Font("Verdana", Font.BOLD, 20);
	...
	public void gotGold(Gold gold) {
		score+= 10;
		newActors.add(new Gold(this));
